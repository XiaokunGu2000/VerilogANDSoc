...
#
# Generated by export_simulation on Sun Aug 25 10:50:43 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './rd_ddr3_fifo.sh' script.

./rd_ddr3_fifo.sh -reset_run
...
./rd_ddr3_fifo.sh -noclean_files

For more information on the script, please type './rd_ddr3_fifo.sh -help'.
