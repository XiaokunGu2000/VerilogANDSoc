...
#
# Generated by export_simulation on Sun Aug 25 10:50:03 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './wr_ddr3_fifo.sh' script.

./wr_ddr3_fifo.sh -reset_run
...
./wr_ddr3_fifo.sh -noclean_files

For more information on the script, please type './wr_ddr3_fifo.sh -help'.
