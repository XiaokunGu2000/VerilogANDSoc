...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../TFT.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../TFT.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"$ref_dir/../../../../TFT.srcs/sources_1/bd/system/ipshared/58e2/hdl" \
       +incdir+"$ref_dir/../../../../TFT.srcs/sources_1/bd/system/ipshared/979d/hdl/verilog" \
       +incdir+"$ref_dir/../../../../TFT.srcs/sources_1/bd/system/ipshared/b2d0/hdl/verilog" \
       +incdir+"../../../../TFT.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../TFT.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../TFT.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
       +incdir+"../../../../TFT.srcs/sources_1/bd/system/ipshared/58e2/hdl" \
       +incdir+"../../../../TFT.srcs/sources_1/bd/system/ipshared/979d/hdl/verilog" \
       +incdir+"../../../../TFT.srcs/sources_1/bd/system/ipshared/b2d0/hdl/verilog" \
       +incdir+"E:/XGK/Vivado/2018.3/data/xilinx_vip/include"
}
